    ...
    <SafeAreaView style={[globalStyles.safeArea, globalStyles.container]}>
      ...
      >
        ...
        <View style={[styles.messageContainer]}>
         <Text style={theme.FONTS.heading}>Spending Entry</Text>
        ...
        <View style={styles.entryPanel}>
          ...
          <Text style={[theme.FONTS.subHeading, styles.titleStyle]}>
            Due By - {dueDate}
            <Text style={globalStyles.superScriptStyle}>
              {CommonFunctions.getDueDateSuffix(dueDate)}
            </Text>
          </Text>
          <View>
            <FlatList
                ...
                return (
                  <TouchableOpacity
                    style={[
                      ...
                      {
                        backgroundColor:
                          item == dueDate ? theme.COLORS.primary : theme.COLORS.white,
                      },
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.itemText,
                        { color: item == dueDate ? theme.COLORS.white : theme.COLORS.primary },
                      ]}
                    >
                      {item}
                    </Text>
          ...
          <TouchableOpacity onPress={handleIsPaid}>
            <View style={globalStyles.flexRow}>
              ...
              <IconLibrary
                name={isPaid ? Icons.Checked : Icons.Unchecked}
                size={24}
                color={theme.COLORS.primary}
              />
            </View>
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity
              style={[styles.button, theme.SHADOWS.mainShadow]}
              onPress={cancelEntry}
            >
